        ...
        <div class="col-md-12 col-xl-12">
            <div class="col-12 " style="padding-left:1.875rem">
                        ...
                        <div class="custom-form-group">
                            <h1 class="h4 m-0">{{ __('Prisegti failai') }}</h1>
                            <table>
                        ...
                        <td class='p-1'><a href="{{route('download',$file->id)}}"><div class=" btn btn-round btn-primary btn-green ">{{ __('Parsisiųsti') }}</div></a></td>
                    ...
                    <form method="post" action="{{route('orders.feedback', $order->id)}}">
                        @csrf
                        <div class="custom-form-group">
                            <h1 class="h4 m-0"> {{ __('Palikti komentarus dizaineriui') }}</h1>
                            <textarea class=" btn-round order-btn-grey form-btn placeholder" name="feedback" placeholder="{{ __('Įrašykite, kas turėtų būti pakoreguota') }}" style="max-width:1295px;width:100%;min-height:138px">{{$order->feedback}}</textarea>
                            
                        </div>
                        <div class="custom-form-group pt-3">
                            <label class="d-inline btn-round  order-btn-red m-1 click"  for="submitfeed">{{ __('Siųsti komentarą') }}</label>
                            <label class="d-inline  btn-round  order-btn-primary m-1 click"  for="submit">{{ __('Fiksuoti darbo pabaigą') }}</label>
                        </div>
