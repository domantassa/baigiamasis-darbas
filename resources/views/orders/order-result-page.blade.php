    ...
    <div class="bg-body-light">
        <div class="content content-full">
            ...
            <div class="custom-form-group">
                        ...
                        {{__('Prisegti rezultatų failus')}}
                        </label>              
                        @endif

                    
                    
                    <form style="height: 15px" action="{{ route('uploadFinalResult', ['order' => $order]) }}" method="post" role="form" class="file-form" enctype="multipart/form-data">
                             @csrf    

                            <input id="file-upload" type="file" name="file" />
                            <button type="submit" class="file-custom btn " data-toggle="tooltip" data-placement="top" title="{{__('Patvirtinti')}}" >
            ...
            <table>
                <tbody>
                            @foreach ($files->where('order_id', $order->id)->where('owner_id',0) as $file)
                           <tr>
